...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_chat_chat__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_profile_profile__ = __webpack_require__(263);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_chat_chat__ = __webpack_require__(264);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChatProvider = (function () {
    ...
    ChatProvider.prototype.getQuestions = function () {
        var _this = this;
        if (this.data) {
    ...
    ChatProvider.prototype.createQuestion = function (question) {
    ...
    ChatProvider.prototype.deleteQuestion = function (id) {
        this.http.delete(this.apiurl + id).subscribe(function (res) {
            console.log(res.json());
        });
    };
    return ChatProvider;
