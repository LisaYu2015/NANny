...
/**
 * Generated class for the TreasureDetailPage page.
 *
 * See http://ionicframework.com/docs/components/#navigation for more info
 * on Ionic pages and navigation.
 */
var TreasureDetailPage = (function () {
    function TreasureDetailPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    TreasureDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad TreasureDetailPage');
    };
